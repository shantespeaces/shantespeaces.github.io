...
<script setup>
// import PortfolioSkw from "@/components/PortfolioSkw.vue";
...
// const routeId = ref(0) // Default route id value
...
//     // selectedProject.value = projets.value.find(proj => proj.type === getTypeFromId(routeId.value)) || {}
